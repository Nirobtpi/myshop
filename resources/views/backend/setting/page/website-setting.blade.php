            ...
            <div class="card-body">
                <form action="{{ route('setting.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="phone_one" id="phone_one" value="{{ $data->phone_one }}">
                    </div>
                    <div class="mb-3">
                        <label for="phone_two" class="form-label">Phone Two</label>
                        <input type="text" class="form-control" name="phone_two" id="phone_two" value="{{ $data->phone_two }}">
                    </div>
                    <div class="mb-3">
                        <label for="mail_email" class="form-label">Mail Email</label>
                        <input type="email" class="form-control" name="mail_email" id="mail_email" value="{{ $data->mail_email }}">
                    </div>
                    <div class="mb-3">
                        <label for="support_email" class="form-label">Support Email</label>
                        <input type="email" class="form-control" id="support_email" value="{{ $data->support_email }}">
                    </div>
                    <div class="mb-3">
                        ...
                        @enderror
                        <img src="{{ $data->support_email }}" alt="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" value="{{ $data->twitter }}" id="twitter" name="twitter">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="youtube" value="{{ $data->youtube }}" name="youtube">
                    </div>
