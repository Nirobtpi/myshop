...
@section('Current_page', 'Add Pickup Point')
@section('title', 'Add Pickup Pointe')
@push('css')
@endpush
@section('content')
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pickup_point_name"
                                value="{{ old('pickup_point_name') }}" id="pickup_point_name">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pickup_point_address"
                                value="{{ old('pickup_point_address') }}" id="pickup_point_address">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pickup_point_phone"
                                value="{{ old('pickup_point_phone') }}" id="pickup_point_phone">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pickup_point_phone_two"
                                value="{{ old('pickup_point_phone_two') }}" id="pickup_point_phone_two">
                            @error('pickup_point_phone')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    <div class="card-footer"> <button type="submit" class="btn btn-primary">Add Pickup Point</button> </div>
                </form>
            </div>
